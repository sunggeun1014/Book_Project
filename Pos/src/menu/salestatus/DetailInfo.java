...
public class DetailInfo {
    ...
    public void info(JPanel panel, String sales, String count, String point, String memberCnt, String todaysales) {
        ...
        headLabels[4] = new JLabel("포인트 사용량");
        headLabels[4].setBounds(450, 220, 150, 15); // 위치와 크기 설정
        headLabels[5] = new JLabel("오늘의 매출");
